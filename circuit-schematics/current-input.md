...
This is the most complex input circuit on the eChook, but once broken down it is still fairly simple. The main component above is an operational amplifier (op-amp). More information on op-amps can be found [here](http://www.electronics-tutorials.ws/opamp/opamp\_1.html) or through Google.
