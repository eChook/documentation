...
1. [Download the eChook Arduino Code](download-the-echook-arduino-code.md)
2. [Install Arduino IDE](install-arduino-ide.md)
3. [Programming the Arduino](programming-the-arduino.md)
