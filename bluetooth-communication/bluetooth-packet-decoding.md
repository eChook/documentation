...
If you want to view the output on a computer, there is a Python script to do that at [https://github.com/eChook/Python-Serial-Interpreter](https://github.com/eChook/Python-Serial-Interpreter). This requires Python 3.x with pySerial and tkinter installed.
